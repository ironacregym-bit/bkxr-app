...
export default function KbRoundTracker({
  ...
  // Helper to select all text on focus -> prevents "020"
  ...
  if (styleType === "EMOM") {
    // EMOM tracker: responsive grid (3-cols on desktop, stacked on small screens)
    return (
      <>
        <div
          className="mt-2"
