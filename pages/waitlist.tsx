  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="Outdoor container gym. Founders £60/month locked for life (first 20). Standard £100/month." />
      ...
      <div className="wrap">
          ...
          {menuOpen ? (
            <div className="mobileMenu" role="dialog" aria-modal="true" aria-label="Menu">
              ...
              <div className="mobileMenuPanel">
                ...
                <button type="button" className="ia-btn ia-btn-primary mobileMenuCta" onClick={() => { setMenuOpen(false); scrollToForm(); }}>Join waitlist</button>
              </div>
            </div>
          ) : null}
          <div className="heroInner">
            <div className="heroLeft">
              ...
              <div className="heroActions">
                <button type="button" className="ia-btn ia-btn-primary heroCta" onClick={scrollToForm}>Join waitlist</button>
              </div>
            ...
            <div className="heroRight" ref={formRef}>
              <div className="formCard ia-tile ia-tile-pad">
                ...
                <div className="formGrid">
                  <input className="form-control formInput" placeholder="Email address" value={email} onChange={(e) => setEmail(e.target.value)} inputMode="email" autoCapitalize="none" autoCorrect="off" />
        ...
        <main className="main">
          <section id="programs" className="section">
            ...
            <div className="sectionCtaRow">
              <button type="button" className="ia-btn ia-btn-primary" onClick={scrollToForm}>Join waitlist</button>
        ...
        <style jsx>{`
          ...
          .heroOverlay{position:absolute;inset:0;background:linear-gradient(180deg,rgba(0,0,0,.48) 0%,rgba(0,0,0,.14) 38%,rgba(0,0,0,.90) 100%)}
          ...
          .brandText{font-weight:850;letter-spacing:.2px}
          .heroNav{display:flex;gap:14px;flex-wrap:wrap;justify-content:flex-end}
          .navLink{appearance:none;background:transparent;border:none;color:rgba(255,255,255,.78);font-weight:700;padding:10px 6px;min-height:44px;cursor:pointer}
          ...
          .heroInner{position:relative;z-index:4;max-width:1100px;margin:0 auto;padding:92px 18px 36px 18px;min-height:100vh;display:grid;grid-template-columns:1.2fr .8fr;gap:18px;align-items:end}
          .headline{margin:0;font-size:54px;line-height:1.02;font-weight:800;letter-spacing:-.6px;text-shadow:0 14px 40px rgba(0,0,0,.55)}
          .badgeRow{margin-top:12px}
          .badge{display:inline-flex;align-items:center;width:fit-content;border-radius:12px;padding:10px 12px;border:1px solid rgba(255,255,255,.14);background:rgba(0,0,0,.22);color:rgba(255,255,255,.92);font-weight:800;font-size:13px;letter-spacing:.1px}
          .subhead{margin:12px 0 0 0;color:rgba(255,255,255,.82);font-size:16px;line-height:1.5;max-width:720px}
          .subStrong{color:#fff;font-weight:800}
          .offerLine{margin-top:10px;display:flex;flex-wrap:wrap;gap:10px;align-items:center;color:rgba(255,255,255,.70);font-weight:650;font-size:13px}
          .offerSep{opacity:.5}
          .offerMuted{opacity:.95}
          .heroActions{margin-top:14px;display:flex;gap:12px;flex-wrap:wrap;align-items:center}
          .heroCta{min-height:50px;border-radius:14px;padding:10px 16px;min-width:220px}
          .heroProof{margin-top:14px;display:flex;gap:10px;flex-wrap:wrap;align-items:center;color:rgba(255,255,255,.72);font-size:13px;font-weight:650}
          .proofDot{width:4px;height:4px;border-radius:999px;background:rgba(255,255,255,.40)}
          .formCard{border-radius:18px;background:rgba(11,15,20,.72);border:1px solid rgba(255,255,255,.08);backdrop-filter:blur(10px)}
          .formTitle{font-weight:800;font-size:18px}
          .formSub{margin-top:6px;color:rgba(255,255,255,.72);line-height:1.35;font-size:14px;font-weight:550}
          ...
          .checkRow{display:flex;gap:10px;align-items:flex-start;color:rgba(255,255,255,.82);font-size:14px;font-weight:550}
          ...
          .sectionTitle{margin:0;font-size:22px;font-weight:780;letter-spacing:-.2px}
          .sectionSub{margin:8px 0 0 0;color:rgba(255,255,255,.72);line-height:1.45;font-weight:550}
          ...
          .cardTitle{font-weight:780;font-size:16px}
          .cardText{margin-top:8px;color:rgba(255,255,255,.72);line-height:1.45;font-weight:550}
          .sectionCtaRow{margin-top:14px;display:flex;gap:12px;flex-wrap:wrap;align-items:center}
          .sectionCtaText{color:rgba(255,255,255,.65);font-size:13px;font-weight:650}
          ...
          .conceptOverlay{position:absolute;inset:0;background:linear-gradient(180deg,rgba(0,0,0,.15),rgba(0,0,0,.78))}
          ...
          .contactLabel{font-weight:780}
          .contactFoot{margin-top:10px;color:rgba(255,255,255,.70);line-height:1.45;font-weight:550}
          ...
          .footerLink{appearance:none;background:transparent;border:none;padding:0;color:rgba(255,255,255,.60);cursor:pointer;text-decoration:underline;text-underline-offset:3px;font-weight:650}
          ...
          .mobileMenuTitle{font-weight:800;margin-bottom:10px}
          .mobileMenuLink{width:100%;text-align:left;appearance:none;background:transparent;border:1px solid rgba(255,255,255,.10);color:rgba(255,255,255,.90);border-radius:12px;padding:12px;min-height:46px;margin-top:8px;font-weight:700;cursor:pointer}
