        ...
        <main>
          ...
          <section className={styles.section}>
            <div className={styles.container}>
              ...
              <p className={styles.text}>
                The training is real. The environment is raw. The people are the point. 
              </p>
            </div>
          </section>
          ...
          <section className={styles.pillarsOuter}>
            ...
            <div className={styles.container}>
              ...
              <div className={styles.sectionHeader}>
                <span className={styles.line} />
                <span className={styles.label}>CONTENT & CULTURE</span>
              </div>
          
              <h2 className={styles.statement}>
                FOUR PILLARS ONE <span className={styles.orange}>FIRE</span>
              </h2>
          
              <p className={styles.text}>
                Everything Iron Acre does lives inside four pillars. How we train, how we think, how we build and who we become
              </p>
            </div>
